...
switch(letterGrade){
    case "A":
    grade = console.log("The student is doing excellently.");
    break;
    case "B":
    grade = console.log("The student is doing well.");
    break;
    case "C":
    grade = console.log("The student is doing alright.");
    break;
    case "D":
    grade = console.log("The student is not doing very well.");
    break;
    case "F":
    grade = console.log("The student is not doing very well.");
}
